...
async function loadCanvasFromServer() {
    try {
        const response = await fetch(Server_ip+'/canvas', {
            method: 'GET',
...
async function clearCanvasOnServer() {
    try {
        const response = await fetch(Server_ip+'/canvas/clear', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' }
        });
...
async function exportCanvas() {
    ...
    try {
        ...
        if (shouldSaveToServer) {
            try {
                const response = await fetch(Server_ip+'/canvas/export', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
...
async function syncCanvasWithServer() {
    ...
    try {
        const response = await fetch(Server_ip+'/canvas/sync', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
...
window.canvasMemory = {
    ...
    isServerAvailable: async () => {
        try {
            const response = await fetch(Server_ip+'/canvas', { method: 'GET' });
            return response.ok;
        } catch {
            return false;
        }
